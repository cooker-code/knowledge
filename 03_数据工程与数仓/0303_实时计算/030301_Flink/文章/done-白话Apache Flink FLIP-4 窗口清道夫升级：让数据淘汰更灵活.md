...
---
title: 白话Apache Flink FLIP-4 窗口清道夫升级：让数据淘汰更灵活
author: 循技漫聊
date:
url: http://mp.weixin.qq.com/s?__biz=Mzg2NTU4NzU4Mw==&mid=2247484458&idx=1&sn=8327d7a0b6cb5eb48bf63abbc1280cb6&chksm=cffc1236947f3fdd83885bd9c0ca1d5931fb65b9707369b2090899fa6f02082632d72900a038&mpshare=1&scene=24&srcid=0310mEWWB8p5Z3PfmqrxrH01&sharer_shareinfo=6bb8e6af33cbd6b12ff6e8ffebba4917&sharer_shareinfo_first=6bb8e6af33cbd6b12ff6e8ffebba4917#rd
---

[白话Apache Flink FLIP-2 窗口函数知道得更多：让窗口处理更加智能](https://mp.weixin.qq.com/s?__biz=Mzg2NTU4NzU4Mw==&mid=2247484448&idx=1&sn=2c11a33d7b7e8c1b4b984b9a2ef58179&scene=21#wechat_redirect)

[白话Apache Flink FLIP-1 任务挂了怎么办：Flink 的明智恢复方案](https://mp.weixin.qq.com/s?__biz=Mzg2NTU4NzU4Mw==&mid=2247484441&idx=1&sn=65466f1ced04a0b9422e75bedd084a32&scene=21#wechat_redirect)
...
1. 1. 在传感器数据处理中，可能想根据数据质量而不是时间顺序来决定保留哪些数据
2. 2. 在交易系统中，可能需要在计算完一批交易的统计信息后，再决定是否要剔除一些异常交易
...
1. 1. 在窗口函数执行前，它会移除那些明显不合理的交易记录，比如价格为负或交易量为零的情况。
2. 2. 在窗口函数执行后，它会根据计算得到的统计值（平均价格和标准差），识别并移除那些可能的异常交易。这些被移除的交易不会影响最终的分析结果，但会被单独记录下来供风控团队进一步分析。
