---
title: FlinkSQL实时数仓SOP流程（一）
author: 炼数成丹
date: 
url: https://mp.weixin.qq.com/s?__biz=MzI4NTc5ODA0OA==&mid=2247483766&idx=1&sn=10d9300e2eb6b8d4eb4b5a136897b7a4&chksm=ea630572ce4bb451a7d5d00797cb55456db4ea58b7b71fa5a85d54a3fe34774a0d7c491694ea&mpshare=1&scene=24&srcid=1220l6OTIxTeBIIMcmOgfGUu&sharer_shareinfo=a3bf30be2df569c8cb07973783b7832e&sharer_shareinfo_first=a3bf30be2df569c8cb07973783b7832e#rd
---
...
```
Interval Join时间线图示：  
订单时间轴：   10:00    10:05    10:10    10:15    10:20  
订单事件：     [订单A]          [订单B]          [订单C]  
                │                 │                 │  
支付窗口：      ├───5分钟窗口───┼───5分钟窗口───┼───5分钟窗口───▶  
                │                 │                 │  
支付事件：           [支付A]           [支付B]           [支付C]  
                10:02           10:08           10:18  
                  
关联结果：      订单A+支付A      订单B+支付B      订单C+支付C
```
...
```
时间版本关联模型：  
事件时间轴：    10:00    10:05    10:10    10:15    10:20  
汇率版本：     [v1.0] ----- [v1.1] ----- [v2.0] ----- [v2.1]  
                │           │           │           │  
订单时间：          10:02       10:08       10:12       10:18  
                │           │           │           │  
关联版本：        v1.0        v1.1        v2.0        v2.1  
                  
版本查找逻辑：  
订单时间10:12 → 查找≤10:12的最新版本 → v2.0
```
...
GROUPBY L.user_id, L.window_start, L.window_end;
```
...
通过本文的系统性梳理，希望你能建立起完整的FlinkSQL实时数仓开发SOP体系，让重复的事情走向 自动化，让复杂的事情走向简单化。