---
title: 详解数据湖的 Schema Evolution(模式演进)
author: Flink
date:
url: http://mp.weixin.qq.com/s?__biz=MzI0NTIxNzE1Ng==&mid=2651225520&idx=1&sn=53bfabdf80d90077bc62334a401159f2&chksm=f2a33f5bc5d4b64d8b5904cc97e71492a60a84b29e8be5fb88b2dceb799b76fceee3e3ea2c4d&mpshare=1&scene=24&srcid=0702d4dxhXhmAuOLe43J00eP&sharer_sharetime=1656724652830&sharer_shareid=ac11efa86a18b42da87220879062c874#rd
---
...
| --- | --- |
| tableName | 表名 |
| col\_spec | 列定义，由五个字段组成，col\_name, col\_type, nullable, comment, col\_position |
...
| --- | --- |
| tableName | 表名 |
| col\_old\_name | 待修改的列名 |
| column\_type | 新的列类型 |
| col\_comment | 列comment |
| column\_name | 列名，放置目标列的新位置。例如，AFTER column\_name 表示目标列放在 column\_name 之后 |
...
| 添加自定义可为空的 Hudi 元列，例如 \_hoodie\_meta\_col | Yes | Yes |  |
| 将根级别字段的数据类型从 int 提升为 long | Yes | Yes | 对于其他类型，Hudi 支持与Avro相同 Avro schema resolution[1] |
| . |  |  |  |
...
[Apache Hudi数据跳过技术加速查询高达50倍](http://mp.weixin.qq.com/s?__biz=MzIyMzQ0NjA0MQ==&mid=2247489276&idx=1&sn=24bb7181aa121310f5ae42245e3127ea&chksm=e81f438adf68ca9c5311d0de0fad2a8d486647dd5e5ecb256eeb0318886931f8ec813e74fa54&scene=21#wechat_redirect)

[深入理解Apache Hudi异步索引机制](http://mp.weixin.qq.com/s?__biz=MzIyMzQ0NjA0MQ==&mid=2247489259&idx=1&sn=1df6ebcc3dd4983dbe9cef91995be7cf&chksm=e81f439ddf68ca8b16cb9f129069dc2d3d620ae66927fc168ced2f3be18f05c192198ab930db&scene=21#wechat_redirect)

[基于Apache Hudi拉链表的全量表极限存储优化方案](http://mp.weixin.qq.com/s?__biz=MzIyMzQ0NjA0MQ==&mid=2247489249&idx=2&sn=d06607b86aa607e4c7d4e6b9aca6c511&chksm=e81f4397df68ca81d55a8029bb80e411f72a186a2ff64017a1fcbb4eacd9e510d833dfd13ff9&scene=21#wechat_redirect)

[腾讯广告业务基于Apache Flink + Hudi的批流一体实践](http://mp.weixin.qq.com/s?__biz=MzIyMzQ0NjA0MQ==&mid=2247489168&idx=1&sn=3b06526cbed1a3189bae606441a5b852&chksm=e81f43e6df68caf07fc4cb00e8a7cae6c0bde6b5f642ea68e15bcd1a34df98c6df03569a2bba&scene=21#wechat_redirect)

[基于TIS构建Apache Hudi千表入湖方案](http://mp.weixin.qq.com/s?__biz=MzIyMzQ0NjA0MQ==&mid=2247489143&idx=1&sn=4fbe280700f7701f60b131347a337f00&chksm=e81f4301df68ca17744b4324955b466409618a57859b54e25a95d4fcc512136f101b82f2cec2&scene=21#wechat_redirect)