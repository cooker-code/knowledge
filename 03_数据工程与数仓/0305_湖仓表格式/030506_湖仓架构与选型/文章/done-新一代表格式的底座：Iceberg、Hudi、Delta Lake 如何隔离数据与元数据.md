> 已吸收至：[[03_数据工程与数仓/0305_湖仓表格式/030506_湖仓架构与选型/030506_核心知识点/湖仓架构与表格式选型边界|湖仓架构与表格式选型边界]]、[[03_数据工程与数仓/0308_元数据血缘与治理/030801_元数据平台/030801_核心知识点/元数据持久化与统计口径边界|元数据持久化与统计口径边界]]
---
