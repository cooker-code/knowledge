> 已吸收至：[[03_数据工程与数仓/0305_湖仓表格式/030503_Iceberg/030503_核心知识点/Iceberg v3 删除向量与行级血缘边界|Iceberg v3 删除向量与行级血缘边界]]、[[03_数据工程与数仓/0305_湖仓表格式/030503_Iceberg/030503_核心知识点/Iceberg生态扩展与实时存储边界|Iceberg生态扩展与实时存储边界]]
---
