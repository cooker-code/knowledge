...
| 认知成熟度 | draft |
| 阅读投入建议 | 精读 |
| 阅读投入理由 | 能补 SeaTunnel 与 DataX/030302_Flink CDC/Paimon 的边界，但原文混入营销、版本口径和配置片段，不能直接当生产 SOP |
...
| 记住 | SeaTunnel 适合“数据搬运和转换”，不自动解决主键、读写隔离、更新合并和历史回补 | 影响选型 | 与 Paimon/030302_Flink CDC 对标 |
