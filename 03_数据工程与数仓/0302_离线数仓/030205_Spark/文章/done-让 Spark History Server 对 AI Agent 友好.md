...
---
title: 让 Spark History Server 对 AI Agent 友好
author: Apache Kyuubi
date:
url: https://mp.weixin.qq.com/s?__biz=Mzg2MDA5MTU4OA==&mid=2247511974&idx=1&sn=becf85af96617b71fded3d716e337810&chksm=cf0d0902c9c7d3ed2dac4cc8c31ec6a0a250ec757b62509c1e3326530a27ad0d8bbd4ea67b1f&mpshare=1&scene=24&srcid=0318HcVdQYifLZQ9Can34EMH&sharer_shareinfo=45156686b58db33948726d2da99609ba&sharer_shareinfo_first=45156686b58db33948726d2da99609ba#rd
---
...
**spark-history-cli**[1] 把整个 Spark History Server 放到你指尖。它是一个 Python CLI 工具，将全部 20 个 REST API 端点封装为交互式 REPL 和一次性命令。列出应用、深入作业和 Stage、检查 SQL 执行、查看 Executor 状态、下载事件日志——全在终端里完成。
...
源码在 GitHub：yaooqinn/spark-history-cli[1]，基于 Apache 2.0 许可证。欢迎提 Issue、PR 和反馈。

---

spark-history-cli[2] v1.0.1 已发布在 PyPI。

参考链接

[1] https://github.com/yaooqinn/spark-history-cli

[2] https://pypi.org/project/spark-history-cli/