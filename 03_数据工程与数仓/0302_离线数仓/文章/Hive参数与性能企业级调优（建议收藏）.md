---
title: Hive参数与性能企业级调优（建议收藏）
author: 浪尖聊大数据
date: 
url: http://mp.weixin.qq.com/s?__biz=MzUyMDA4OTY3MQ==&mid=2247509527&idx=1&sn=f833db5e7e97648add14a99dc552f8f5&chksm=f9ed5f3fce9ad6290823340be08a4f302a4ca5a296eed84515fb80d216070e4e57b221a7df30&mpshare=1&scene=24&srcid=0902ntZ2jWLNNbOF6q9mT4zp&sharer_shareinfo=8584e22b5b0db20bf5a0154b6c14a28a&sharer_shareinfo_first=8584e22b5b0db20bf5a0154b6c14a28a#rd
---
...
我们简单分析上面的SQl语句，就是将每个年龄的最大和最小的生日获取出来放到同一张表中，union all 前后的两个语句都是对同一张表按照s\_age进行分组，然后分别取最大值和最小值。对同一张表相同的字段进行两次分组，这造成了极大浪费，我们能不能改造下呢，当然是可以的，为大家介绍一个语法：`from ... insert into ...` ，这个语法将from前置，作用就是使用一张表，可以进行多次插入操作：
...
[解决hive小文件过多问题](http://mp.weixin.qq.com/s?__biz=MzUyMDA4OTY3MQ==&mid=2247506005&idx=2&sn=4a98e17957d06ca6c5fb3fd9296f6a2e&chksm=f9ed217dce9aa86baaf5bab93b5df6992072ffa617c33f64f57409c1427c5ed6179e1110aa47&scene=21#wechat_redirect)
