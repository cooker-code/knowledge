...
- 本模块先看宏观流程，再看文章：[知识地图](030803_知识地图.md)。
- 新文章必须先归入流程节点，再判断是补充、冲突、不同层次还是降权。
- `文章/` 只保留原文锚点，长期知识必须沉淀到 `030803_核心知识点/` 下的主题文件。
...
| 血缘图谱与 AI 助手应用边界 | [血缘图谱与AI助手应用边界](030803_核心知识点/血缘图谱与AI助手应用边界.md) | 数据血缘 + Neo4j/MCP/LLM + 影响分析 + 权限审计 | 判断 AI 助手接入血缘时哪些能力必须由图谱保证 | 大模型不能替代解析、采集、版本和置信度 |
| 血缘可视化与大图交互边界 | [血缘可视化与大图交互边界](030803_核心知识点/血缘可视化与大图交互边界.md) | 数据血缘 + G6/大图/路径查询 + 前后端协同 | 判断血缘图如何服务排障和影响分析 | 可视化不是全量铺图，而是按场景裁剪和解释 |
