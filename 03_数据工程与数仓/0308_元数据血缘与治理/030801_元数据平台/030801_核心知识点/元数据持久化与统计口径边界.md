...
- 本地文件：
  - [从零开始学Flink：Flink SQL 元数据持久化实战](<../文章/done-从零开始学Flink：Flink SQL 元数据持久化实战.md>)
  - [基于Hive进行数仓建设的资源元数据信息统计](../文章/done-基于Hive进行数仓建设的资源元数据信息统计.md)
  - [新一代表格式的底座：Iceberg、Hudi、Delta Lake 如何隔离数据与元数据](<../../../0305_湖仓表格式/030506_湖仓架构与选型/文章/done-新一代表格式的底座：Iceberg、Hudi、Delta Lake 如何隔离数据与元数据.md>)
