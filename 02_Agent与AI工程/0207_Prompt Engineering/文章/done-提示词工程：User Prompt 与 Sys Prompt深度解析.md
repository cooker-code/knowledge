...
---
title: 提示词工程：User Prompt 与 Sys Prompt深度解析
author: 小普rel
date:
url: https://mp.weixin.qq.com/s?__biz=Mzg4ODc2OTM4Ng==&mid=2247484065&idx=1&sn=cb1b54198b9d65a0a2356baebc00de1c&chksm=cef09ef485e5279825bb4bf522d28c23bc974546389f5bcd998159d93b41d619325a001c3329&mpshare=1&scene=24&srcid=1112QnnCc5oM0w7ecKmHK0WR&sharer_shareinfo=78f2fc890300994fae13be9e5cc8579b&sharer_shareinfo_first=78f2fc890300994fae13be9e5cc8579b#rd
---
...
通过这个对比可以看出，其实模型的回答并没有太大区别，反正我是没看出来。同时也说明了一件事：系统提示词的效果取决于底模的指令遵循能力与上下文处理能力；对于能力较弱的模型，系统提示词过长反而会导致指令解析不完整，从而降低输出质量。
...
| --- | --- | --- |
| 方式 | 工具/示例 | 优点 |
| 版本命名法 | prompt\_v1、v2.1、v3\_final | 简单直观，适合个人使用 |
...
好了，今天就先说到这儿吧，下次我们聊一下关于Multi\_Agent架构的大厂实战项目，目前正在整理和脱敏中......