---
title: 关于智能体（AI Agent）最常用框架，做了超详细的总结！
author: Datawhale
date: 
url: https://mp.weixin.qq.com/s?__biz=MzIyNjM2MzQyNg==&mid=2247715107&idx=1&sn=59771b9fa13895009c813543f5b480e9&chksm=e9e89cfec1f80607f64b4b77dbcd8a095169214b17dc143339fe4e230b308327e1aa5571aaa3&mpshare=1&scene=24&srcid=1129SfBj0FzqQXWIQG2QDY5A&sharer_shareinfo=d0136d3640f95b011bc3cf3eb111e935&sharer_shareinfo_first=d0136d3640f95b011bc3cf3eb111e935#rd
---

# Datawhale干货  **作者：陈思州，**Datawhale成员**** 为了便于大家更系统的入门和学习，最近，我们会为大家分享关于AI智能体的系列内容：[《Hello-Agents》项目正式发布，一起从零学习智能体](https://mp.weixin.qq.com/s?__biz=MzIyNjM2MzQyNg==&mid=2247714071&idx=1&sn=772a6c61e1efea4280b7fbb1fc769a9f&scene=21#wechat_redirect)。
...
4. **简化可观测性与调试过程**：当智能体的行为变得复杂时，理解其决策过程变得至关重要。一个精心设计的框架可以内置强大的可观测性能力。例如，通过引入事件回调机制（Callbacks），我们可以在智能体生命周期的关键节点（如 on\_llm\_start, on\_tool\_end, on\_agent\_finish）自动触发日志记录或数据上报，从而轻松地追踪和调试智能体的完整运行轨迹。这远比在代码中手动添加 print 语句要高效和系统化。
...
这个 model\_info 字典帮助 AutoGen 了解模型的能力边界，从而更好地适配不同的模型服务。
...
[5] Microsoft. AutoGen - UserProxyAgent [EB/OL]. (2024). https://microsoft.github.io/autogen/stable/reference/python/autogen\_agentchat.agents.html#autogen\_agentchat.agents.UserProxyAgent.
