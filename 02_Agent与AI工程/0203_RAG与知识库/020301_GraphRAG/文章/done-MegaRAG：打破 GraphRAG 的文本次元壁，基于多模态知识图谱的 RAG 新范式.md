...
---
title: MegaRAG：打破 GraphRAG 的文本次元壁，基于多模态知识图谱的 RAG 新范式
author: Machi
date:
url: https://mp.weixin.qq.com/s?__biz=MzIyMjE5Njk1Mw==&mid=2651252749&idx=1&sn=5f672f73de3fc35eaa7f45c72ceecf28&chksm=f251c217d4fe0d567ea59e53bc63115366ac051d959ed8fcfe7c2c976155aa313222d001456b&mpshare=1&scene=24&srcid=0106WtKFcOntD3TRnMBaNxi8&sharer_shareinfo=4bdbfccef4e8aeec8d2e4f335e739c51&sharer_shareinfo_first=4bdbfccef4e8aeec8d2e4f335e739c51#rd
---
...
然而，现有的 GraphRAG（包括 LightRAG）存在一个致命缺陷：**它们是单模态的（Text-Only）**。 当面对 PDF、PPT、技术手册等**富视觉文档**时：
...
1. **Global Merge**：将所有页的局部图合并为初始图 。
2. **Subgraph Retrieval**：对于第  页，不直接喂全量图（太大了），而是根据当前页的实体，去  中检索一个 **Top-K 子图**。
...
图建好了，怎么检索？文本和图片属于不同模态，传统的 Text Embedding 模型（如 OpenAI ada-003）搞不定图片节点。 MegaRAG 使用了 **GME (General Multimodal Embedder)** （基于 Qwen2-VL-2B 微调）：
...
* Stage 1 (Intermediate)： 这里的 Prompt 让模型只看 **KG** 生成一个“逻辑推导版答案”。
