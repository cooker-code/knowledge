...
- 本模块先看宏观流程，再看文章：[流程化知识点总览](knowledge/02_Agent与AI工程/0203_RAG与知识库/GraphRAG/核心知识点/流程化知识点总览.md)。
...
|---|---|---|---|---|
| GraphRAG 图谱构建、检索与多模态边界 | [GraphRAG图谱构建检索与多模态边界](核心知识点/GraphRAG图谱构建检索与多模态边界.md) | GraphRAG + 实体关系抽取/Schema/Cypher/多模态图谱 + 多跳关系问答 + 向量 RAG 边界 | 判断什么时候从向量 RAG 升级到图谱增强检索 | 图提供关系和可解释路径，但建图、Schema、评估和权限是主要门槛 |
