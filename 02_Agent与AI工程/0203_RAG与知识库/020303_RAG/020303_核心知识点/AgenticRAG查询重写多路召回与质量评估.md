...
- 本地文件：[Agentic RAG 开发实践（查询重写、多路召回、路由决策、质量评估、多步重查）](<../文章/done-Agentic RAG 开发实践（查询重写、多路召回、路由决策、质量评估、多步重查）.md>)
...
| 理解 | 关键词召回 + 向量召回 + RRF + Cross-Encoder 是常见混合召回链路 | 横向补足 RAG 检索模块 | 后续补 020304_RAGFlow/检索评估 |
