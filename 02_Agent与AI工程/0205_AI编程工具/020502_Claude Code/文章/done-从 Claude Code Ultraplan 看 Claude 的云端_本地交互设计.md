...
---
title: 从 Claude Code Ultraplan 看 Claude 的云端/本地交互设计
author: CuiLiang.ai
date: 亮叔亮叔
url: https://mp.weixin.qq.com/s?__biz=MzAwMDIzMjQ0OQ==&mid=2247483983&idx=1&sn=b3007ca8efb32ea439179b1450edadb3&chksm=9b1e89cd19f5ec570895cbcb31427d8cb3e02c4042030300004a597b4fd3879341d83f3e0984&mpshare=1&scene=24&srcid=0510XHExxlpEkEHyUDsulVKt&sharer_shareinfo=2bba01f5a5be64c5b8dcf6fe9c239cd5&sharer_shareinfo_first=2bba01f5a5be64c5b8dcf6fe9c239cd5#rd
---
...
进一步验证：git remote -v 显示的不是 github.com，而是 http://local\_proxy@127.0.0.1:xxxxx/git/你的用户名/你的仓库。这是云 VM 里的 GitHub 代理层，代理验证 scoped credential，附上你的实际 GitHub token，再转发到 GitHub。
...
两者的底层逻辑一致：不是所有阶段都需要同样的环境，按阶段的实际需求分配资源和界面。
