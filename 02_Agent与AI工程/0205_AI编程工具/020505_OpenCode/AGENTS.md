...
- 本模块先看宏观流程，再看文章：[知识地图](020505_核心知识点/知识地图.md)。
- 新文章必须先归入流程节点，再判断是补充、冲突、不同层次还是降权。
- `文章/` 只保留原文锚点，长期知识必须沉淀到 `020505_核心知识点/`。
...
|---|---|---|---|---|
| OpenCode 与 oh-my-opencode 编排边界 | [OpenCode与oh-my-opencode编排边界](020505_核心知识点/OpenCode与oh-my-opencode编排边界.md) | OpenCode + 终端 Agent + Categories/Skills/Prometheus/Atlas + 多 Agent 编排与失败恢复 + 配置治理边界 | OpenCode 如何从单 Agent 执行进入工程编排 | 把“开源版 Cursor”校准为“终端 Agent 本体 + 编排增强层” |
