...
---
title: 一套完整的Codex团队运行规范（企业级AI交付实践）
author: React
date: DarioDario
url: https://mp.weixin.qq.com/s?__biz=MzAxMTMyOTk3MA==&mid=2456457399&idx=1&sn=ba25edf323d22eab01323f5c02e704de&chksm=8db6042af452f977e44f5d89dc5bc24506039b08266b655105a4b20a8a21624c1c5e3667af43&mpshare=1&scene=24&srcid=0602lMjrbgPtrmLIGCy7RHTG&sharer_shareinfo=d124ac557b5de46f3fe8b889aedbc569&sharer_shareinfo_first=d124ac557b5de46f3fe8b889aedbc569#rd
---

起初，我是被Claude Code 的多Agent所吸引，然后逐步迷恋上Claude，但是3月中旬，当我已经将Claude Code多Agent的研发团队搭建好开始疯狂工作之余， 我的账号无缘无故被封。

甚至，我不惜重金买独立的服务器和IP，并用上指纹浏览器，但结果依然无济于事，一周内 6个账号被封，我彻底对Claude Code失去了耐心。 此时我突然想起来，我之前曾为gpt 买过单，便转头拥抱Codex。

在Codex上，多Agent、skill、MCP等 Claude Code 有的功能， Codex上都有。于是，我总结了在Claude Code上因为搭建虚拟团队，没有事先对各个角色做行为约束，导致各个角色时不时出现工作漏洞，总是无法将一个任务闭环。我便开始，借助Codex 官方文档和 GPT 5.4 超强的逻辑推理，构建了一下这套 可以正常干活的草台班子： Codex 多角色协作运行规范。

虽然只是一个草台班子，但是还是要有一个牛逼的定位：

> 面向企业级软件与 AI 功能交付的多角色协作运行规范。 目标：把“角色矩阵”下沉成“可执行协议”，让每个 agent 在实际协作时知道何时可开工、何时必须阻塞、应输出什么、交给谁。

接下来，我将把我本地这套草台班子的运行规则分享给大家：
...
以上内容，可以直接复制并粘贴在本地项目 AGENTS.md文件中，配套的agents内容会在接下来的文章中逐步分享给大家，同时也会用具体的案例分享这套草台班子的运行效果。

如果对这套草台班子每个角色的定义感兴趣，可以留言分享自己的观点。