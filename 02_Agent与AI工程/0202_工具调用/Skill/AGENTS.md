...
- 本模块先看宏观流程，再看文章：[流程化知识点总览](knowledge/02_Agent与AI工程/0202_工具调用/Skill/核心知识点/流程化知识点总览.md)。
...
|---|---|---|---|---|
| Skill、MCP、项目规则边界 | [Skill、MCP、项目规则的边界](核心知识点/Skill、MCP、项目规则的边界.md) | Skill + 工具调用 + 动态能力包/外部协议/项目规则 + 区分边界 + 避免 Claude 生态混归 | 区分 Skill、MCP、CLAUDE.md、Plugin | 把“Claude 相关能力”拆成能力包、协议、规则和生态分发 |
