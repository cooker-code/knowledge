> 已吸收至：[[02_Agent与AI工程/0202_工具调用/020202_MCP/020202_核心知识点/MCP生产接入与治理边界|MCP生产接入与治理边界]]、[[02_Agent与AI工程/0202_工具调用/020202_MCP/020202_核心知识点/PostgreSQLMCPServer结构化数据访问边界|PostgreSQLMCPServer结构化数据访问边界]]
---
