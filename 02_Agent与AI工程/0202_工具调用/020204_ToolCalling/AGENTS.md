...
|---|---|---|---|---|
| Tool Search 与工具上下文治理 | [ToolSearch与工具上下文治理](020204_核心知识点/ToolSearch与工具上下文治理.md) | Tool Calling + 工具检索 + defer loading + Prompt Cache + 工具膨胀治理 | 避免大量工具定义常驻上下文导致成本、缓存和选择准确率问题 | Tool Search 是上下文治理机制，不是简单工具列表搜索 |
