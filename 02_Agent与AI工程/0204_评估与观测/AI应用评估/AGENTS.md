...
- 本模块先看宏观流程，再看文章：[流程化知识点总览](knowledge/02_Agent与AI工程/0204_评估与观测/AI应用评估/核心知识点/流程化知识点总览.md)。
...
|---|---|---|---|---|
| Langfuse 与 RAGAS 监控评估闭环 | [Langfuse与RAGAS监控评估闭环](核心知识点/Langfuse与RAGAS监控评估闭环.md) | AI 应用 + Trace/Span/Generation + RAGAS 指标 + 观测与评估闭环 + 可回归质量门禁 | 把 AI 应用质量从主观体验变成可观测、可评分、可回归 | 观测回答“发生了什么”，评估回答“答得好不好”，两者要串进 CI |
