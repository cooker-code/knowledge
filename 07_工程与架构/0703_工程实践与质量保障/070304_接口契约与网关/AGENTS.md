...
- 本模块先看宏观流程，再看文章：[知识地图](070304_知识地图.md)。
- 新文章必须先归入流程节点，再判断是补充、冲突、不同层次还是降权。
- `文章/` 只保留原文锚点，知识地图维护在 `070304_知识地图.md`；长期知识点写入 `070304_核心知识点/` 目录。
...
- 本轮核心入口：[接口契约网关与协议边界准则](070304_核心知识点/接口契约网关与协议边界准则.md)。
- 本轮知识地图入口：[070304_接口契约与网关知识地图](070304_知识地图.md)。
