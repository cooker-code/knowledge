...
- 本模块先看宏观流程，再看文章：[知识地图](070206_知识地图.md)。
- 新文章必须先归入流程节点，再判断是补充、冲突、不同层次还是降权。
- `文章/` 只保留原文锚点，知识地图维护在 `070206_知识地图.md`；长期知识点写入 `070206_核心知识点/` 目录。
...
- 从 `99_人工筛查/07_工程与架构` 拉回来源：12 篇。
- 本轮核心入口：[前端工程化工具链与质量门禁准则](070206_核心知识点/前端工程化工具链与质量门禁准则.md)。
- 本轮知识地图入口：[070206_前端工程化与质量知识地图](070206_知识地图.md)。
