...
- 本模块先看宏观流程，再看文章：[知识地图](070201_知识地图.md)。
- 新文章必须先归入流程节点，再判断是补充、冲突、不同层次还是降权。
- `文章/` 只保留原文锚点，知识地图维护在 `070201_知识地图.md`；长期知识点写入 `070201_核心知识点/` 目录。
...
- 从 `99_人工筛查/07_工程与架构` 拉回来源：8 篇。
- 本轮核心入口：[Nuxt全栈应用边界准则](070201_核心知识点/Nuxt全栈应用边界准则.md)。
- 本轮知识地图入口：[070201_Nuxt知识地图](070201_知识地图.md)。
