---
title: DuckDB论文解读 | DuckDB-SGX2
author: digoal德哥
date: 
url: https://mp.weixin.qq.com/s?__biz=MzA5MTM4MzY1Mw==&mid=2247498319&idx=1&sn=05e3323e427c58c981af6bf8bcf8ed42&chksm=91f52d76ea673553f77a68817ddd72b98787eae9284767829bf31a0aa4f54099f0e7ec8a2f4e&mpshare=1&scene=24&srcid=1107uoGVT51IEjMsnWYaweaX&sharer_shareinfo=ec3d8f19cf3e21e870e165d44d83c409&sharer_shareinfo_first=ec3d8f19cf3e21e870e165d44d83c409#rd
---

## DuckDB论文解读 | DuckDB-SGX2
...
* \*\*行式存储 (Row-based)\*\*：`ID | 姓名 | 年龄``1, 张三, 25; 2, 李四, 30; 3, 王五, 22`适合一次性读取整条记录（如查询张三的所有信息）。
* **列式存储 (Columnar)**：`ID: 1, 2, 3;``姓名: 张三, 李四, 王五;``年龄: 25, 30, 22`非常适合分析查询。例如，计算所有人的平均年龄，只需读取“年龄”这一列，而无需加载“ID”和“姓名”，大大减少了 I/O 数据量。同时，同一列的数据类型相同，非常容易被**压缩**。
