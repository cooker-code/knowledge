...
- 本模块先看宏观流程，再看文章：[知识地图](040302_核心知识点/知识地图.md)。
- 新文章必须先归入流程节点，再判断是补充、冲突、不同层次还是降权。
- `文章/` 只保留原文锚点，长期知识必须沉淀到 `040302_核心知识点/`。
...
| 文章 | 阅读投入建议 | 处理建议 |
|---|---|---|
| [SQLite 又被重新看见：为什么 2026 年大家开始怀念一个单文件数据库？](<文章/SQLite 又被重新看见：为什么 2026 年大家开始怀念一个单文件数据库？.md>) | 精读候选 | 标题中的年份和“怀念”要降权，重点吸收单文件、低运维、读多写少、单写者和 PostgreSQL 边界 |
| [果不其然，SQLite的研究引来一堆人的关注，上一篇爆了](文章/果不其然，SQLite的研究引来一堆人的关注，上一篇爆了.md) | 精读候选 | 降权群宣和流量表达，重点吸收动态类型、STRICT 表、时间类型表达、库锁和传统关系库思维不适配 |

## 已沉淀核心知识点

| 主题 | 文件 | 问题指纹 | 解决什么问题 | 认知增量 |
|---|---|---|---|---|
| 暂无 | - | SQLite + 待精读文章 + 待抽取机制 + 待确认边界 | 先建立技术入口，后续精读再沉淀正式知识点 | 当前只形成 draft 级候选判断 |
