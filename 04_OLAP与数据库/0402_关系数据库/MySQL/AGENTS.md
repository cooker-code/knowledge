...
| 文章 | 技术对象 | 阅读投入建议 | 状态 |
|---|---|---|---|
| [FastAPI 不用 SQLModel，如何用 DBUtils 直连 MySQL 数据库](../文章/FastAPI%20不用%20SQLModel，如何用%20DBUtils%20直连%20MySQL%20数据库.md) | 连接池 / FastAPI 集成 | 精读 | 精读候选 |
...
| [企业级 MySQL 数据分析助手落地方案：基于 DeepAgents 的全流程实践](../文章/企业级%20MySQL%20数据分析助手落地方案：基于%20DeepAgents%20的全流程实践.md) | MySQL + AI 分析 | 略读 | 待处理 |
| [性能比拼: MySQL vs PostgreSQL](../文章/性能比拼_%20MySQL%20vs%20PostgreSQL.md) | 对标 PostgreSQL | 精读 | 精读候选（与 PG 共享）|
| [一次 SQL 查询优化原理分析：900W+ 数据，从 17s 到 300ms](文章/一次%20SQL%20查询优化原理分析：900W+%20数据，从%2017s%20到%20300ms.md) | InnoDB 分页优化 / 延迟关联 | 精读 | 从通用查询优化目录纠偏迁入 |
