> 已吸收至：[[04_OLAP与数据库/0402_关系数据库/040201_MySQL/040201_核心知识点/MySQL查询优化与分页边界|MySQL查询优化与分页边界]]
---
title: 一次 SQL 查询优化原理分析：900W+ 数据，从 17s 到 300ms
author: 浪尖聊大数据
date:
url: http://mp.weixin.qq.com/s?__biz=MzUyMDA4OTY3MQ==&mid=2247507112&idx=2&sn=fbaa1d9e61fb6eb92c5d9b734c9ff404&chksm=f9ed2580ce9aac96eb42e9cc60544b8b41a1624e4163be620cb523444848263de54c8beb07c4&mpshare=1&scene=24&srcid=06225zOLQfLnb4VMFrUUy3Nq&sharer_sharetime=1655860977071&sharer_shareid=ac11efa86a18b42da87220879062c874#rd
---
...
为了证实select \* from test where val=4 limit 300000,5是扫描300005个索引节点和300005个聚簇索引上的数据节点，我们需要知道MySQL有没有办法统计在一个sql中通过索引节点查询数据节点的次数。我先试了Handler\_read\_\*系列，很遗憾没有一个变量能满足条件。
