...
- 本模块先看宏观流程，再看文章：[流程化知识点总览](knowledge/05_数据分析与BI/0501_语义层与智能问数/Text-to-SQL/核心知识点/流程化知识点总览.md)。
...
|---|---|---|---|---|
| Text-to-SQL 工程架构与 Schema Linking | [Text-to-SQL工程架构与SchemaLinking](核心知识点/Text-to-SQL工程架构与SchemaLinking.md) | Text-to-SQL + Schema Linking/澄清/ReviseAgent/语义层 + SQL 准确性 + 可追责问数 | Text-to-SQL 为什么不能只靠 Prompt + DDL | 把智能问数从“模型生成 SQL”校准为“语义层、链接、校验和人机协作系统” |
